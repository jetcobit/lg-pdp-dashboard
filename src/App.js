...
const processSteps = ['에셋 취합', '컨텐츠 제작', '본부 및 법인 검토', '수정', '법무검토', 'Authoring', 'Publishing'];
...
export default function App() {
    ...
    useEffect(() => {
        // --- 데모용 샘플 데이터 ---
        // 이 부분은 URL 없이도 대시보드가 동작하도록 하는 샘플 데이터입니다.
        // 실제 구글 시트 데이터 연동 시에는 이 부분을 삭제하거나 주석 처리하세요.
...
TV,200,영국 (UK),Gallery,본부 및 법인 검토,In Progress,2025-07-19
TV,200,영국 (UK),Gallery,수정,Not Started,2025-07-24
TV,200,영국 (UK),Gallery,법무검토,Not Started,2025-07-29
TV,200,영국 (UK),Gallery,Authoring,Not Started,2025-08-04
TV,200,영국 (UK),Gallery,Publishing,Not Started,2025-08-09
TV,200,영국 (UK),Dimension,에셋 취합,Completed,2025-07-11
TV,200,영국 (UK),Dimension,컨텐츠 제작,In Progress,2025-07-21
TV,200,영국 (UK),Dimension,본부 및 법인 검토,Not Started,2025-07-26
TV,200,영국 (UK),Dimension,수정,Not Started,2025-07-31
TV,200,영국 (UK),Dimension,법무검토,Not Started,2025-08-05
TV,200,영국 (UK),Dimension,Authoring,Not Started,2025-08-10
TV,200,영국 (UK),Dimension,Publishing,Not Started,2025-08-15
모니터,30,이탈리아 (Italy),Gallery,에셋 취합,Completed,2025-07-14
모니터,30,이탈리아 (Italy),Gallery,컨텐츠 제작,Completed,2025-07-19
모니터,30,이탈리아 (Italy),Gallery,본부 및 법인 검토,In Progress,2025-07-24
모니터,30,이탈리아 (Italy),Gallery,수정,Not Started,2025-07-29
모니터,30,이탈리아 (Italy),Gallery,법무검토,Not Started,2025-08-04
모니터,30,이탈리아 (Italy),Gallery,Authoring,Not Started,2025-08-09
모니터,30,이탈리아 (Italy),Gallery,Publishing,Not Started,2025-08-14`;
    ...
    const totalModels = useMemo(() => projectData.reduce((sum, cat) => sum + cat.totalModels, 0), [projectData]);
